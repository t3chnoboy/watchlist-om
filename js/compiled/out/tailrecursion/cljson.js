...
goog.require('cljs.reader');
goog.require('cljs.reader');
tailrecursion.cljson.EncodeTagged = (function (){var obj14612 = {};return obj14612;
})();
tailrecursion.cljson._encode = (function _encode(o){if((function (){var and__7860__auto__ = o;if(and__7860__auto__)
...
{var x__8499__auto__ = (((o == null))?null:o);return (function (){var or__7872__auto__ = (tailrecursion.cljson._encode[goog.typeOf(x__8499__auto__)]);if(or__7872__auto__)
{return or__7872__auto__;
} else
{var or__7872__auto____$1 = (tailrecursion.cljson._encode["_"]);if(or__7872__auto____$1)
...
{
var G__14613 = i__$1;
var G__14614 = cljs.core.rest.call(null,c);
i = G__14613;
c = G__14614;
continue;
}
...
tailrecursion.cljson.encode = (function encode(x){var temp__4124__auto__ = (function (){var and__7860__auto__ = cljs.core._STAR_print_meta_STAR_;if(cljs.core.truth_(and__7860__auto__))
...
{if((function (){var G__14618 = x;if(G__14618)
{var bit__8522__auto__ = null;if(cljs.core.truth_((function (){var or__7872__auto__ = bit__8522__auto__;if(cljs.core.truth_(or__7872__auto__))
{return or__7872__auto__;
} else
{return G__14618.tailrecursion$cljson$EncodeTagged$;
}
})()))
{return true;
} else
{if((!G__14618.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,tailrecursion.cljson.EncodeTagged,G__14618);
} else
{return false;
}
}
...
{if((cljs.core.map_QMARK_.call(null,x)) && (!((function (){var G__14620 = x;if(G__14620)
{var bit__8522__auto__ = (G__14620.cljs$lang$protocol_mask$partition0$ & (67108864));if((bit__8522__auto__) || (G__14620.cljs$core$IRecord$))
{return true;
} else
{if((!G__14620.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IRecord,G__14620);
} else
{return false;
}
}
...
{var or__7872__auto__ = tailrecursion.cljson.interpret.call(null,x);if(cljs.core.truth_(or__7872__auto__))
{return or__7872__auto__;
} else
...
tailrecursion.cljson.decode_tagged = (function decode_tagged(o){var tag = (o[(0)]);var G__14622 = tag;switch (G__14622) {
case "v":
...
var G__14624 = (i + (1));
var G__14625 = len;
var G__14626 = cljs.core.conj_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__14624;
len = G__14625;
out = G__14626;
continue;
...
var G__14627 = (i + (2));
var G__14628 = len;
var G__14629 = cljs.core.assoc_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])),tailrecursion.cljson.decode.call(null,(o[(i + (1))])));
i = G__14627;
len = G__14628;
out = G__14629;
continue;
...
{{
var G__14630 = (i - (1));
var G__14631 = cljs.core.conj.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__14630;
out = G__14631;
continue;
}
...
var G__14632 = (i + (1));
var G__14633 = len;
var G__14634 = cljs.core.conj_BANG_.call(null,out,tailrecursion.cljson.decode.call(null,(o[i])));
i = G__14632;
len = G__14633;
out = G__14634;
continue;
...
break;
default:
var temp__4124__auto__ = (function (){var or__7872__auto__ = cljs.core.get.call(null,cljs.core.deref.call(null,cljs.reader._STAR_tag_table_STAR_),tag);if(cljs.core.truth_(or__7872__auto__))
{return or__7872__auto__;
} else
