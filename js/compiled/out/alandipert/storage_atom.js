...
goog.require('goog.Timer');
goog.require('tailrecursion.cljson');
alandipert.storage_atom.IStorageBackend = (function (){var obj24328 = {};return obj24328;
})();
alandipert.storage_atom._get = (function _get(this$,not_found){if((function (){var and__11469__auto__ = this$;if(and__11469__auto__)
...
{var x__12117__auto__ = (((this$ == null))?null:this$);return (function (){var or__11481__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__12117__auto__)]);if(or__11481__auto__)
{return or__11481__auto__;
} else
{var or__11481__auto____$1 = (alandipert.storage_atom._get["_"]);if(or__11481__auto____$1)
...
alandipert.storage_atom._commit_BANG_ = (function _commit_BANG_(this$,value){if((function (){var and__11469__auto__ = this$;if(and__11469__auto__)
...
{var x__12117__auto__ = (((this$ == null))?null:this$);return (function (){var or__11481__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__12117__auto__)]);if(or__11481__auto__)
{return or__11481__auto__;
} else
{var or__11481__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);if(or__11481__auto____$1)
{return or__11481__auto____$1;
} else
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__12057__auto__,writer__12058__auto__,opt__12059__auto__){return cljs.core._write.call(null,writer__12058__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var this$__$1 = this;var temp__4220__auto__ = self__.store.getItem(tailrecursion.cljson.clj__GT_cljson.call(null,self__.key));if(cljs.core.truth_(temp__4220__auto__))
{var existing = temp__4220__auto__;return tailrecursion.cljson.cljson__GT_clj.call(null,existing);
} else
{return not_found;
}
});
...
alandipert.storage_atom.store = (function store(atom,backend){var existing = alandipert.storage_atom._get.call(null,backend,new cljs.core.Keyword("alandipert.storage-atom","none","alandipert.storage-atom/none",604942529));var debounce = alandipert.storage_atom.debounce_factory.call(null);if(cljs.core._EQ_.call(null,new cljs.core.Keyword("alandipert.storage-atom","none","alandipert.storage-atom/none",604942529),existing))
...
var G__24334 = atom;cljs.core.add_watch.call(null,G__24334,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__24334,existing,debounce){
return (function (p1__24331_SHARP_,p2__24332_SHARP_,p3__24329_SHARP_,p4__24330_SHARP_){if(cljs.core.truth_((function (){var and__11469__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;if(cljs.core.truth_(and__11469__auto__))
{return cljs.core.not_EQ_.call(null,p3__24329_SHARP_,p4__24330_SHARP_);
} else
{return and__11469__auto__;
}
})()))
{return debounce.call(null,((function (G__24334,existing,debounce){
return (function (){return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__24330_SHARP_);
});})(G__24334,existing,debounce))
,(function (){var or__11481__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;if(cljs.core.truth_(or__11481__auto__))
{return or__11481__auto__;
} else
...
{var temp__4222__auto__ = tailrecursion.cljson.cljson__GT_clj.call(null,e.key);if(cljs.core.truth_(temp__4222__auto__))
{var sk = temp__4222__auto__;if(cljs.core._EQ_.call(null,sk,k))
{var value = tailrecursion.cljson.cljson__GT_clj.call(null,e.newValue);var _STAR_watch_active_STAR_24336 = alandipert.storage_atom._STAR_watch_active_STAR_;try{alandipert.storage_atom._STAR_watch_active_STAR_ = false;
return cljs.core.reset_BANG_.call(null,atom,value);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_24336;
}} else
{return null;
}
} else
...
alandipert.storage_atom.link_storage = (function link_storage(atom,k){return window.addEventListener("storage",(function (p1__24337_SHARP_){return alandipert.storage_atom.maybe_load_backend.call(null,atom,k,p1__24337_SHARP_);
}));
});
