...
goog.require('goog.Timer');
goog.require('tailrecursion.cljson');
alandipert.storage_atom.IStorageBackend = (function (){var obj14601 = {};return obj14601;
})();
alandipert.storage_atom._get = (function _get(this$,not_found){if((function (){var and__7860__auto__ = this$;if(and__7860__auto__)
{return this$.alandipert$storage_atom$IStorageBackend$_get$arity$2;
} else
{return and__7860__auto__;
}
})())
{return this$.alandipert$storage_atom$IStorageBackend$_get$arity$2(this$,not_found);
} else
{var x__8499__auto__ = (((this$ == null))?null:this$);return (function (){var or__7872__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__8499__auto__)]);if(or__7872__auto__)
{return or__7872__auto__;
} else
{var or__7872__auto____$1 = (alandipert.storage_atom._get["_"]);if(or__7872__auto____$1)
{return or__7872__auto____$1;
} else
...
alandipert.storage_atom._commit_BANG_ = (function _commit_BANG_(this$,value){if((function (){var and__7860__auto__ = this$;if(and__7860__auto__)
...
{var x__8499__auto__ = (((this$ == null))?null:this$);return (function (){var or__7872__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__8499__auto__)]);if(or__7872__auto__)
{return or__7872__auto__;
} else
{var or__7872__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);if(or__7872__auto____$1)
{return or__7872__auto____$1;
} else
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__8439__auto__,writer__8440__auto__,opt__8441__auto__){return cljs.core._write.call(null,writer__8440__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__14607 = atom;cljs.core.add_watch.call(null,G__14607,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__14607,existing,debounce){
return (function (p1__14604_SHARP_,p2__14605_SHARP_,p3__14602_SHARP_,p4__14603_SHARP_){if(cljs.core.truth_((function (){var and__7860__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;if(cljs.core.truth_(and__7860__auto__))
{return cljs.core.not_EQ_.call(null,p3__14602_SHARP_,p4__14603_SHARP_);
} else
{return and__7860__auto__;
}
})()))
{return debounce.call(null,((function (G__14607,existing,debounce){
return (function (){return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__14603_SHARP_);
});})(G__14607,existing,debounce))
,(function (){var or__7872__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;if(cljs.core.truth_(or__7872__auto__))
{return or__7872__auto__;
} else
...
{var value = tailrecursion.cljson.cljson__GT_clj.call(null,e.newValue);var _STAR_watch_active_STAR_14609 = alandipert.storage_atom._STAR_watch_active_STAR_;try{alandipert.storage_atom._STAR_watch_active_STAR_ = false;
return cljs.core.reset_BANG_.call(null,atom,value);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_14609;
}} else
{return null;
}
} else
...
alandipert.storage_atom.link_storage = (function link_storage(atom,k){return window.addEventListener("storage",(function (p1__14610_SHARP_){return alandipert.storage_atom.maybe_load_backend.call(null,atom,k,p1__14610_SHARP_);
}));
});
