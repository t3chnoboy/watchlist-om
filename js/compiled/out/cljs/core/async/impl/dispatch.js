...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18152 = (0);while(true){
var m_18153 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18153 == null))
{} else
{m_18153.call(null);
if((count_18152 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__18154 = (count_18152 + (1));
count_18152 = G__18154;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7858__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7858__auto__)
