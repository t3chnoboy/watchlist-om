...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18158 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t18158 = (function (val,box,meta18159){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t18158.cljs$lang$type = true;
cljs.core.async.impl.channels.t18158.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t18158";
cljs.core.async.impl.channels.t18158.cljs$lang$ctorPrWriter = (function (this__8437__auto__,writer__8438__auto__,opt__8439__auto__){return cljs.core._write.call(null,writer__8438__auto__,"cljs.core.async.impl.channels/t18158");
});
cljs.core.async.impl.channels.t18158.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18158.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18160){var self__ = this;
var _18160__$1 = this;return self__.meta18159;
});
cljs.core.async.impl.channels.t18158.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18160,meta18159__$1){var self__ = this;
var _18160__$1 = this;return (new cljs.core.async.impl.channels.t18158(self__.val,self__.box,meta18159__$1));
});
cljs.core.async.impl.channels.__GT_t18158 = (function __GT_t18158(val__$1,box__$1,meta18159){return (new cljs.core.async.impl.channels.t18158(val__$1,box__$1,meta18159));
});
}
return (new cljs.core.async.impl.channels.t18158(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8440__auto__,writer__8441__auto__,opts__8442__auto__){return cljs.core._write.call(null,writer__8441__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8437__auto__,writer__8438__auto__,opt__8439__auto__){return cljs.core._write.call(null,writer__8438__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_18161 = self__.takes.pop();if((taker_18161 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18161))
{var take_cb_18162 = cljs.core.async.impl.protocols.commit.call(null,taker_18161);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18162,taker_18161,this$__$1){
return (function (){return take_cb_18162.call(null,null);
});})(take_cb_18162,taker_18161,this$__$1))
);
} else
{}
{
